...
export const SignupEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Verify your email to get started with {SITE}</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          <Link href={siteUrl} style={link}>{SITE}</Link>. Please verify your
          email address (<strong>{recipient}</strong>) to activate your account.
        </Text>
        ...
        <Text style={hint}>
          This link will expire shortly. If you didn't create an account, you
...
const link = { color: '#005ebb', textDecoration: 'none' }
